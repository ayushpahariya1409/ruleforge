  ...
  return (
    <div className="min-h-screen bg-surface-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-primary-100/40 blur-[120px]" />
        <div className="absolute bottom-[-20%] right-[-10%] w-[40%] h-[40%] rounded-full bg-primary-50/60 blur-[120px]" />
      </div>
      ...
      <div className="z-10 w-full animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-surface-900 tracking-tight">
            Join Rule<span className="text-primary-600">Forge</span>
          </h1>
          <p className="text-surface-400 text-sm mt-1">Create your evaluation engine account</p>
        </div>
        <RegisterForm />
      </div>
